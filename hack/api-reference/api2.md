...
<ul>
<li>
<a href="#openstack.machine.gardener.cloud%2fv1alpha2">openstack.machine.gardener.cloud/v1alpha2</a>
</li>
</ul>
<h2 id="openstack.machine.gardener.cloud/v1alpha2">openstack.machine.gardener.cloud/v1alpha2</h2>
<p>
<p>Package v1alpha2 is a version of the API.</p>
</p>
Resource Types:
<ul></ul>
<h3 id="openstack.machine.gardener.cloud/v1alpha2.MachineProviderConfig">MachineProviderConfig
</h3>
<p>
...
<code>spec</code></br>
<em>
<a href="#openstack.machine.gardener.cloud/v1alpha2.MachineProviderConfigSpec">
...
<em>
<a href="#openstack.machine.gardener.cloud/v1alpha2.OpenStackNetwork">
OpenStackNetwork
</a>
</em>
</td>
...
<h3 id="openstack.machine.gardener.cloud/v1alpha2.MachineProviderConfigSpec">MachineProviderConfigSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#openstack.machine.gardener.cloud/v1alpha2.MachineProviderConfig">MachineProviderConfig</a>)
</p>
<p>
...
<h3 id="openstack.machine.gardener.cloud/v1alpha2.OpenStackNetwork">OpenStackNetwork
</h3>
<p>
(<em>Appears on:</em>
<a href="#openstack.machine.gardener.cloud/v1alpha2.MachineProviderConfigSpec">MachineProviderConfigSpec</a>)
</p>
<p>
...
<td>
<p>NetworkID is the ID of a network the instance should belong to. Takes precedence over &ldquo;Name&rdquo; if
both are given.</p>
</td>
</tr>
<tr>
...
<td>
<em>(Optional)</em>
<p>Cidr specifies the CIDR-range that created machines may use as part of the network.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Name is the name of a network the instance should belong to.</p>
</td>
</tr>
</tbody>
</table>
