...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*openstack.MachineProviderConfigSpec)(nil), (*MachineProviderConfigSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*openstack.OpenStackNetwork)(nil), (*OpenStackNetwork)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*MachineProviderConfigSpec)(nil), (*openstack.MachineProviderConfigSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*OpenStackNetwork)(nil), (*openstack.OpenStackNetwork)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha1_MachineProviderConfigSpec_To_openstack_MachineProviderConfigSpec(in *MachineProviderConfigSpec, out *openstack.MachineProviderConfigSpec, s conversion.Scope) error {
	...
	// WARNING: in.PodNetworkCidr requires manual conversion: does not exist in peer-type
...
func autoConvert_openstack_MachineProviderConfigSpec_To_v1alpha1_MachineProviderConfigSpec(in *openstack.MachineProviderConfigSpec, out *MachineProviderConfigSpec, s conversion.Scope) error {
	...
	out.UseConfigDrive = (*bool)(unsafe.Pointer(in.UseConfigDrive))
	out.ServerGroupID = (*string)(unsafe.Pointer(in.ServerGroupID))
	// WARNING: in.AdditionalNetworks requires manual conversion: does not exist in peer-type
	return nil
}
...
func autoConvert_v1alpha1_OpenStackNetwork_To_openstack_OpenStackNetwork(in *OpenStackNetwork, out *openstack.OpenStackNetwork, s conversion.Scope) error {
	...
	out.Name = in.Name
	// WARNING: in.PodNetwork requires manual conversion: does not exist in peer-type
	return nil
}
